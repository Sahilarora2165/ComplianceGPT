...
export default function DocumentIntakeWorkspace({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-4">
      ...
      <div className={compact ? "min-h-0 flex-1" : "grid min-h-0 flex-1 grid-cols-1 gap-6 xl:grid-cols-12"}>
        <div className={compact ? "min-h-0 flex-1" : "min-h-0 xl:col-span-8"}>
              ...
              {uploadedDocument ? (
                <div className="space-y-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 max-h-80 overflow-y-auto rounded-xl border border-slate-200 bg-white p-3 text-sm leading-6 text-slate-700 whitespace-pre-wrap break-words">
        ...
        {!compact && (
          <div className="flex min-h-0 flex-col xl:col-span-4">
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl bg-white p-5 shadow-panel">
              ...
              {recentUploads.length ? (
                  ...
                  {recentUploads.map((event, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span className="shrink-0 rounded bg-slate-900 px-2 py-0.5 text-[10px] font-bold text-white">
                ...
                <div className="flex min-h-0 flex-1 items-center">
                  <div className="w-full rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-8 text-center text-sm text-muted">
